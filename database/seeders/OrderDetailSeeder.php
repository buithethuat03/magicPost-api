...
class OrderDetailSeeder extends Seeder
{
    ...
    public function run() : void
    {
        ...
        OrderDetail::create([
            ...
            'first_transaction_id' => $firstTransactionId = 1001,
            'last_transaction_id' => $lastTransactionId = 1000,
            'first_warehouse_id' => $firstWarehouseId = 10001,
            'last_warehouse_id' => $lastWarehouseId = 10000,
            'weight' => 5.00,
            'shipping_fee' => 10.00,
            'orderType' => '0', 
            'status' => 'Đã giao hàng', 
